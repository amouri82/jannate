 ...
 */
final class Version20200429152244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student ADD level_id INT DEFAULT NULL, ADD class_type VARCHAR(30) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student DROP level_id, DROP class_type');
    }
}
