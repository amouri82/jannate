 ...
 */
final class Version20200903232934 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE teacher_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE note CHANGE user_id teacher_id INT DEFAULT NULL');
