 ...
 */
final class Version20200621144604 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student ADD manager_id INT NOT NULL, ADD regular_date DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE student ADD CONSTRAINT FK_B723AF33783E3463 FOREIGN KEY (manager_id) REFERENCES employee (id)');
        $this->addSql('CREATE INDEX IDX_B723AF33783E3463 ON student (manager_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE student DROP FOREIGN KEY FK_B723AF33783E3463');
        $this->addSql('DROP INDEX IDX_B723AF33783E3463 ON student');
        $this->addSql('ALTER TABLE student DROP manager_id, DROP regular_date');
    }
}
